 ...
 *
 * @category    Mageplaza
 * @package     Mageplaza_Ajax
 * @copyright   Copyright (c) Mageplaza (http://www.mageplaza.com/)
 * @license     https://www.mageplaza.com/LICENSE.txt
 */

namespace Mageplaza\AjaxLayeredNavigation\Helper;
...
class Data extends AbstractData
{
    ...
    {
        if (!$this->filterModel) {
            $this->filterModel = $this->objectManager->create('Mageplaza\AjaxLayeredNavigation\Model\Layer\Filter');
        }
